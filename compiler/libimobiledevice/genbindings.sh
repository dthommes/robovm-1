...
rename SWIGTYPE_p_syslog_relay_client_private SyslogRelayClientRef
rename SWIGTYPE_p_screenshotr_client_private ScreenShotrClientRef
...
rename syslog_relay_error_t SyslogRelayError
rename screenshotr_error_t ScreenShotrError
